...
In this work, we propose a distillation framework to bridge the gap betwwen efficiency and expressiveness of graph neural networks. MuGSI achieves the same performance as 3-WL GNN and GIN in most of datasets, and be 10x-100x more memory efficiency.
